...
const ligarDesligarBtn = document.getElementById('onOff');
...
function ligarDesligar() {
  ...
  if (corpoPokedex.classList.contains('corpoPokedex-desligado')) {
    ...
    document.getElementById('exibicao').style.backgroundColor = 'darkslategray';
    document.getElementById('nome-pokemon').style.backgroundColor = 'darkslategray';
  } else {
    getInformation(currentPokemonId);
